                ...
                while True:
                    ...
                    if j <= 2:
                        ...
                        conn.send(str.encode(
                            "Total questions are 10. First one to reach 4 points wins.First enter yes for buzzer and then answer the question.If you don't know the question just don't press buzzer"))
                        time.sleep(1)
                        ...
                        print("Connection has been established :Client " + str(j) + " " + address[0])
                        os.system("lxterminal -e /home/mala/Desktop/script.sh");
                        ...
                        print("cannot connect more than 5")
                        break;
...
while True:
    ...
    time.sleep(1)
    if len(all_connections) == 3 and isFirstTime == False:
        #thread_function()
        isFirstTime = True        
        for i in range(len(Questions)):
            ...
            if (len(response1[0]) > 0):
                ...
                for conn in all_connections:
                    ...
                    if conn != conn_name:
                        conn.send(str.encode("Sorry, Player " + str(
                            all_connections.index(conn_name) + 1) + " has pressed the buzzer."))
